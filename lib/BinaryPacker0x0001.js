...
BinaryPacker0x0001["getBytes"] = BinaryPacker0x0001_getBytes; // BinaryPacker0x0001.getBytes(source:Any):Integer

// --- implements ------------------------------------------
function BinaryPacker0x0001_getBytes(/*source*/) { // @arg Object - { x, y, w, h }
                                                   // @ret Integer
// header
//  | bytes | keyword    | value                               |
//  |-------|------------|-------------------------------------|
...
//  | 2     | h          | 0x0000-0xffff                       |  --+
    ...
    var headerLength = 8; // signature + formatID + bodyLength
    var bodyLength   = 8;
...
//}@dev
    ...
    var result = new Uint8Array(BinaryPacker0x0001_getBytes());
    var x = source["x"];
    var y = source["y"];
    var w = source["w"];
    var h = source["h"];
...
//{@dev
    ...
    $valid($type(header, "Object|null"), BinaryPacker0x0001_unpack, "header");
//}@dev
