...
//}@dev
    ...
    var buffer = new Uint8Array(BinaryPacker0x0001_getBodyLength() + 8);
    var cursor = BinaryPacker["writeHead"](buffer, 0, 8, 0x0001);
...
//}@dev
    ...
    head = head || BinaryPacker["readHeader"](source);
