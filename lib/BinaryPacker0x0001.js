...
BinaryPacker0x0001["getSize"] = BinaryPacker0x0001_getSize; // BinaryPacker0x0001.getSize(source:Any):Integer
...
// --- implements ------------------------------------------
function BinaryPacker0x0001_getSize(/*source*/) { // @arg Object - { x, y, w, h }
                                                  // @ret Integer
// header
//  | size | keyword    | value                               |
//  |------|------------|-------------------------------------|
...
//}@dev
    ...
    var result = new Uint8Array(BinaryPacker0x0001_getSize());
    var x = source["x"];
    var y = source["y"];
    var w = source["w"];
    var h = source["h"];
